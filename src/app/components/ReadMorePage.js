  ...
  return (
    <div className="container mx-auto p-4">
      <header className="text-center mb-8">
        <h1 className="text-4xl font-bold">About SupportCafe</h1>
      </header>
      <main>
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2">Welcome to SupportCafe</h2>
          <p>
            SupportCafe is the premier platform for project builders to collect funds and bring their visions to life. Whether you are an artist, entrepreneur, developer, or social activist, SupportCafe provides the tools and support you need to gather financial backing and connect with a community of supporters who believe in your project.
          </p>
        </section>
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2">Why Choose SupportCafe?</h2>
          <ul className="list-disc list-inside">
            ...
            <li><strong>Support for All Types of Projects:</strong> No matter the size or scope of your project, SupportCafe is here to help. From small community initiatives to large-scale innovations, our platform is versatile enough to accommodate a wide range of projects.</li>
            ...
            <li><strong>Secure Payment Processing:</strong> We prioritize the security of your funds and personal information. SupportCafe exclusively supports Razorpay as our payment gateway to ensure seamless and secure transactions.</li>
          </ul>
        </section>
        <section className="mb-8">
        ...
        <section className="mb-8">
          ...
          <p>To receive funds through SupportCafe, it is essential that you have a Razorpay account. Razorpay is a leading payment gateway provider known for its reliability and security. Here’s why you need it:</p>
          ...
          <ul className="list-disc list-inside">
            ...
            <li><strong>Seamless Integration:</strong> Easily link your Razorpay account to SupportCafe for smooth and hassle-free payment processing.</li>
      ...
      <footer className="text-center mt-8">
        <p><strong>SupportCafe</strong> - Empowering creators, one chai at a time.</p>
      </footer>
    </div>
  );
};
